...
{
    public partial class PenjualanOnProgressAdmin : System.Web.UI.Page
    {
        ...
        protected void ltlsearch_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtpenjualan = GetDataPenjualan(txtboxnamacustomer.Text, txtboxproduk.Text, txtboxtransno.Text, ddlstatus.SelectedValue, txtboxtanggalawal.Text, txtboxtanggalakhir.Text, Convert.ToInt64(userid));
        ...
        public virtual DataTable GetDataPenjualan(string custname,  string produknama, string transno, string status, string dateawal, string dateakhir, Int64 id)
        {
            ...
            var query = (from transpenjualan in context.TRANS_PENJUALAN
                         ...
                         & transpenjualan.TANGGAL >= dateawal1 & transpenjualan.TANGGAL <= dateakhir1 & transpenjualan.STATUS != "CAN" & 
                          transpenjualan.STATUS != "FINISH" & cust.REF_USER_ID == id
                         select new
                         {
        ...
        public virtual DataTable GetDataTransPenjualan(Int64 id)
        {
            ...
            var query = (from transpenjualan in context.TRANS_PENJUALAN
                         ...
                         join product in context.PRODUCTs
                         on checkouts.PROD_ID equals product.PROD_ID
                         where transpenjualan.STATUS != "CAN" && transpenjualan.STATUS != "FINISH" && cust.REF_USER_ID == id
                         select new
                         {
                             transpenjualan.TRANS_PENJUALAN_ID,
                             transpenjualan.NAMA_PENERIMA,
