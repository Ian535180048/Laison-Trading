        ...
        <div class="col-lg-7">
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating mb-3 mb-md-0">
                        ...
                        <asp:Label ID="lbltotallempar" runat="server" Visible="false" />
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="uptotal">
                        <ContentTemplate>
                            <asp:Label ID="lbltotalsemua" runat="server" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <asp:TextBox runat="server" ID="txtboxalamat" TextMode="MultiLine" Rows="3" />
        ...
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvpembayaran" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Total Produk" ID="ltlammount" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_harga" Text='<%# Eval("PRICE", "{0:Rp 0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbltotalharga" Text='<%# Eval("TOTAL", "{0:Rp 0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
