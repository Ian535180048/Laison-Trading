...
{
    public partial class HistoryTransaksi : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable dtpenjualan = GetDataTransPenjualan(Convert.ToInt64(id));
        ...
        protected void ltlsearch_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtpenjualan = GetDataPenjualan(txtboxnamacustomer.Text, txtboxproduk.Text, txtboxtransno.Text, ddlstatus.SelectedValue, txtboxtanggalawal.Text, txtboxtanggalakhir.Text, Convert.ToInt64(id));
        ...
        #region method
        public virtual DataTable GetDataPenjualan(string custname, string produknama, string transno, string status, string dateawal, string dateakhir, Int64 id)
        {
            LAISONEntities context = new LAISONEntities();
            ...
            var query = (from transpenjualan in context.TRANS_PENJUALAN
                         ...
                         & transpenjualan.STATUS != "PD_REQ" && transpenjualan.STATUS != "PD_APV_REQ" && transpenjualan.STATUS != "PAID" && cust.REF_USER_ID == id && transpenjualan.STATUS !="SENT" && transpenjualan.STATUS != "REQ_REFUND" & transpenjualan.STATUS != "CAN_REQ"
                         select new
                         {
        ...
        public virtual DataTable GetDataTransPenjualan(Int64 id)
        {
            LAISONEntities context = new LAISONEntities();
            ...
            var query = (from transpenjualan in context.TRANS_PENJUALAN
                         ...
                         join product in context.PRODUCTs
                         on checkouts.PROD_ID equals product.PROD_ID
                         where transpenjualan.STATUS != "PD_REQ" && transpenjualan.STATUS != "PD_APV_REQ" && transpenjualan.STATUS != "PAID" && cust.REF_USER_ID == id && transpenjualan.STATUS != "SENT" && transpenjualan.STATUS !="REQ_REFUND" & transpenjualan.STATUS != "CAN_REQ"
                         select new
                         {
                             transpenjualan.TRANS_PENJUALAN_ID,
                             transpenjualan.NAMA_PENERIMA,
