...
namespace SkripsiIanKeefe
{
    public partial class MainCustomer : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lbluser.Text = user.FIRST_NAME + " " + user.LAST_NAME;
        }
        #endregion

        #region button

        protected void lbsettings_Click1(object sender, EventArgs e)
        {
            LAISONEntities context = new LAISONEntities();
            var id = (string)Session["id"];
        ...
        protected void lbrefund_Click1(object sender, EventArgs e)
        {
            LAISONEntities context = new LAISONEntities();
            var id = (string)Session["id"];
            string userid = Convert.ToString(id);
        ...
        protected void lbpenerimaan_Click1(object sender, EventArgs e)
        {
            LAISONEntities context = new LAISONEntities();
            var id = (string)Session["id"];
            string userid = Convert.ToString(id);
        ...
        protected void lbpembayaran_Click1(object sender, EventArgs e)
        {
            LAISONEntities context = new LAISONEntities();
            var id = (string)Session["id"];
            string userid = Convert.ToString(id);
