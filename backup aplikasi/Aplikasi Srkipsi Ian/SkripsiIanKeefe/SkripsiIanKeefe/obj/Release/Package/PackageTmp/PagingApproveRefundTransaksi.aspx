<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PagingApproveRefundTransaksi.aspx.cs" Inherits="SkripsiIanKeefe.PagingApproveRefundTransaksi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager runat="server" ID="smApplication" />

    <h1 class="mt-4">Persetujuan Pengembalian Barang</h1>

    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Persetujuan Pengembalian Barang</li>
    </ol>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating mb-3 mb-md-0">
                        <li class="breadcrumb-item active">No Transaksi</li>
