...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <asp:UpdatePanel runat="server" ID="uperror" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:Label ID="lblerrordelete1" Text="Data Produk Tidak Dapat Dihapus Dikarenakan Terdapat Penjualan Dalam Produk Ini" Visible="false" runat="server" ForeColor="Red" />
                <asp:Label ID="lblerrordelete2" Text="Data Produk Tidak Dapat Dihapus Dikarenakan Terdapat Transaksi Pembelian Stok Barang Dalam Produk Ini" Visible="false" runat="server" ForeColor="Red" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
            ...
            <asp:GridView runat="server" ID="gvproduct" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped" OnRowCommand="gvproduct_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lb_harga" Text='<%# Eval("PRICE", "{0:Rp 0,00}") %>' runat="server" />
                            <%--<asp:Label ID="lbl_trans_no" Text='<%# Eval("TRANS_NO") %>' runat="server"   />--%>
                        </ItemTemplate>
                    </asp:TemplateField>
