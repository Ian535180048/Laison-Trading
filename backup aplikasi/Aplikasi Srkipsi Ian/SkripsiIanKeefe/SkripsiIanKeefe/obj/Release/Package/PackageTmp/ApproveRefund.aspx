...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="col-lg-7">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <asp:LinkButton Text="Setuju" CssClass="btn btn-primary" runat="server" ID="lbapprove" OnClick="lbapprove_Click" />
                </div>
                <div class="col-md-6">
                    <asp:LinkButton Text="Tidak Setuju" CssClass="btn btn-primary" ID="lbrjc" OnClick="lbrjc_Click" runat="server" />
                </div>
            </div>
        </div>
    </div>
