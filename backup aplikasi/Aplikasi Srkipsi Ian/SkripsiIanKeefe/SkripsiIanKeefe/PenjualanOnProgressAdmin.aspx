<%@ Page Title="" Language="C#" MasterPageFile="~/MainCustomer.Master" AutoEventWireup="true" CodeBehind="PenjualanOnProgressAdmin.aspx.cs" Inherits="SkripsiIanKeefe.PenjualanOnProgressAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Daftar Pembelian Yang Sedang Berjalan</li>
    </ol>
            ...
            <div class="row mb-3">
                ...
                <%--<div class="col-md-6">
                    <div class="form-floating">
                        <li class="breadcrumb-item active">Nomor C</li>
