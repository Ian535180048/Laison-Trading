...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Penambahan Data Produk</li>
    </ol>
    ...
    <div class="container">
        <div class="col-lg-7">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating mb-3 mb-md-0">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ErrorMessage="Number Only" ControlToValidate="txtboxharga" ValidationExpression="[0-9]+(,[0-9]+)*" runat="server" ForeColor="Red" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating">
            ...
            <div class="row mb-3">
                ...
                <asp:TextBox ID="txtboxdescr" TextMode="MultiLine" Rows="8" runat="server" />
            </div>
