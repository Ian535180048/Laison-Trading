...
namespace SkripsiIanKeefe
{
    public partial class HomeCustomer : System.Web.UI.Page
    {
        ...
        protected void txtboxharga_mulai_TextChanged(object sender, EventArgs e)
        {
            double ammount = Convert.ToDouble(txtboxharga_mulai.Text);
            txtboxharga_mulai.Text = ammount.ToString("#,##0");
        }

        protected void txtboxhargaakhir_TextChanged(object sender, EventArgs e)
        {
            double ammount = Convert.ToDouble(txtboxhargaakhir.Text);
            txtboxhargaakhir.Text = ammount.ToString("#,##0");
        }
    }
}