            ...
            <asp:GridView runat="server" ID="gvjurnal" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped table-responsive">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_debit" Text='<%# Eval("IN_AMT", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_kredit" Text='<%# Eval("OUT_AMT", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                        <FooterTemplate>
            ...
            <asp:GridView runat="server" ID="gvneraca" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped table-responsive">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_debit" Text='<%# Eval("SUM_IN_AMT", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_kredit" Text='<%# Eval("SUM_OUT_AMT", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
