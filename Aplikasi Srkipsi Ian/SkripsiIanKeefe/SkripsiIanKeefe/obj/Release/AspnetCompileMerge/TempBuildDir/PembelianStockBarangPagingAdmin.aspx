...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Pembelian Stok Barang Paging</li>
    </ol>
        ...
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvstokbarang" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped" OnRowCommand="gvstokbarang_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Supplier Nama" ID="ltlsuppliernama" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Produk Nama" ID="ltlproduknama" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Ammount Produk" ID="ltlstockammount" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_total_harga" Text='<%# Eval("HARGA", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
