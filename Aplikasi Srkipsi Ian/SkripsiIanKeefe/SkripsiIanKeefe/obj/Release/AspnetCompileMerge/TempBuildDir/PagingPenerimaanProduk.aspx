<%@ Page Title="" Language="C#" MasterPageFile="~/MainCustomer.Master" AutoEventWireup="true" CodeBehind="PagingPenerimaanProduk.aspx.cs" Inherits="SkripsiIanKeefe.PagingPenerimaanProduk" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="mt-4">Penerimaan</h1>

    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Penerimaan Paging</li>
    </ol>
