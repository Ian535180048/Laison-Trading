<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PagingApproveCancelTransaksi.aspx.cs" Inherits="SkripsiIanKeefe.PagingApproveCancelTransaksi1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Cancel Penjualan Paging</li>
    </ol>
        ...
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvpenjualan" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped" OnRowCommand="gvpenjualan_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Customer First Name" ID="ltlcustfirstname" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_harga_produk" Text='<%# Eval("HARGA_PRODUK") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Cancel" ID="ltledit" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:ImageButton ID="imgedit" ImageUrl="~/Image/edit.png" CommandName="CAN" runat="server" CausesValidation="false" />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Reject Cancel" ID="ltledit" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:ImageButton ID="imgrjc" ImageUrl="~/Image/edit.png" CommandName="RJC" runat="server" CausesValidation="false" />
                        </ItemTemplate>
                    </asp:TemplateField>
