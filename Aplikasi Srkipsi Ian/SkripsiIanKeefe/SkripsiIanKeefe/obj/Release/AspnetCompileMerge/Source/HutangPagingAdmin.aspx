...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Hutang Paging</li>
    </ol>
        ...
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvhutang" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped" OnRowCommand="gvhutang_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Client Nama" ID="ltlclientnama" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Hutang Ammount" ID="ltlhutangammount" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lbl_hutang_ammount" Text='<%# Eval("HUTANG_AMT", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_sisa_hutang" Text='<%# Eval("SISA", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
