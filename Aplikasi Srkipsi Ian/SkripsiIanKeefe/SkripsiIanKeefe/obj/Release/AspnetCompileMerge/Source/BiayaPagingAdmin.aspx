...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Biaya Paging</li>
    </ol>
        ...
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvbeban" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped" OnRowCommand="gvbeban_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        <HeaderTemplate>
                            <asp:Literal Text="Beban Tipe" ID="ltlbebantipe" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_ammount" Text='<%# Eval("AMT","{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
