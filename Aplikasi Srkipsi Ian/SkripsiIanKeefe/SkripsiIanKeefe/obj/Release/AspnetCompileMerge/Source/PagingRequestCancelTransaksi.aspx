<%@ Page Title="" Language="C#" MasterPageFile="~/MainCustomer.Master" AutoEventWireup="true" CodeBehind="PagingRequestCancelTransaksi.aspx.cs" Inherits="SkripsiIanKeefe.PagingRequestCancelTransaksi" %>
            ...
            <asp:GridView runat="server" ID="gvpenjualan" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped" OnRowCommand="gvpenjualan_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_harga_produk" Text='<%# Eval("HARGA_PRODUK", "{0:0,00}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
