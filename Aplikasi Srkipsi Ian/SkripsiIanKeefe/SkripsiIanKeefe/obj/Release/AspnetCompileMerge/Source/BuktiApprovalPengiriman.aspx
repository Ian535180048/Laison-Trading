<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BuktiApprovalPengiriman.aspx.cs" Inherits="SkripsiIanKeefe.BuktiApprovalPengiriman" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Bukti Resi Pengiriman</li>
    </ol>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating mb-3 mb-md-0">
                        <li class="breadcrumb-item active">Mohon Upload Bukti Resi Pengiriman</li>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        ...
                        <asp:Label id="lblongkir" runat="server" />
                    </div>
                </div>
            </div>
            <br />
                ...
                <div class="col-md-6">
                    <div class="form-floating mb-3 mb-md-0">
                        <asp:UpdatePanel runat="server" ID="uperror" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label Text="Rese Pengiriman belum diupload" ID="lblerror" ForeColor="Red" Visible="false" runat="server" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
            ...
            <asp:GridView runat="server" ID="gvproduct" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lb_harga" Text='<%# Eval("TOTAL_HARGA") %>' runat="server" />
                            <%--<asp:Label ID="lbl_trans_no" Text='<%# Eval("TRANS_NO") %>' runat="server"   />--%>
                        </ItemTemplate>
                    </asp:TemplateField>
