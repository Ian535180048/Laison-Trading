...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="col-lg-7">
            ...
            <!-- Least Square -->
            <%--<asp:UpdatePanel ID="updatatahunls" runat="server" Visible="false" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                <li class="breadcrumb-item active">Prediksi untuk berapa bulan :</li>
                                <asp:DropDownList runat="server" ID="dlbulans">
                                    <asp:ListItem Text="1" Value="1" />
                                    <asp:ListItem Text="2" Value="2" />
                                    <asp:ListItem Text="3" Value="3" />
                                    <asp:ListItem Text="4" Value="4" />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <li class="breadcrumb-item active">Produk yang diprediksi :</li>
                                <asp:DropDownList ID="dlprodukls" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                <li class="breadcrumb-item active">Harga Pemesanan Produk :</li>
                                <asp:TextBox runat="server" ID="txtboxpemesananproduk" />
                                <asp:RequiredFieldValidator ErrorMessage="Required" ControlToValidate="txtboxpemesananproduk" runat="server" ForeColor="Red" />
                                <asp:RegularExpressionValidator ErrorMessage="Number Only" ControlToValidate="txtboxpemesananproduk" ValidationExpression="^\d+$" runat="server" ForeColor="Red" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <li class="breadcrumb-item active">Biaya Pengiriman Produk :</li>
                                <asp:TextBox runat="server" ID="txtboxpengirimanproduk" />
                                <asp:RequiredFieldValidator ErrorMessage="Required" ControlToValidate="txtboxpengirimanproduk" runat="server" ForeColor="Red" />
                                <asp:RegularExpressionValidator ErrorMessage="Number Only" ControlToValidate="txtboxpengirimanproduk" ValidationExpression="^\d+$" runat="server" ForeColor="Red" />
                            </div>
                        </div>
                    </div>
                </ContentTemplate>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating mb-3 mb-md-0">
                        <asp:LinkButton Text="Calculate" CssClass="btn btn-primary" ID="lbcalculate" OnClick="lbcalculate_Click" runat="server" />
                       <%-- <asp:UpdatePanel runat="server" Visible="false" UpdateMode="Conditional" ID="uperrorcalc">
                            <ContentTemplate>
                                <asp:Label Text="Metode belum dipilih" ForeColor="Red" ID="lblmetode" runat="server" />
                            </ContentTemplate>
                        </asp:UpdatePanel>--%>
                    </div>
                </div>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="uptotalls">
        <ContentTemplate>
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating mb-3 mb-md-0">
            ...
            <asp:GridView runat="server" ID="gvdataaktualds" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped table-responsive">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbl_p" Text='<%# Eval("p", "{0:0.00}") %>' runat="server"Visible="false" />
                            <%--<asp:Label ID="lbl_trans_no" Text='<%# Eval("TRANS_NO") %>' runat="server"   />--%>
                        </ItemTemplate>
                    </asp:TemplateField>
