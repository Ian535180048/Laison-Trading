...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upcart" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvcart" AutoGenerateColumns="false" GridLines="None" CssClass="table table-hover table-striped table-responsive" OnRowCommand="gvcart_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Image ID="imgcart" ImageUrl='<%# Eval("FOTO") %>' runat="server" Style="width: 300px; height: 300px;" />
                        </ItemTemplate>
                    </asp:TemplateField>
