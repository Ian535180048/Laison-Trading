...
{
    public partial class PagingApproveCancelTransaksi1 : System.Web.UI.Page
    {
        #region page load
        ...
        protected void ltlsearch_Click(object sender, EventArgs e)
        {
            ...
            DataTable transpenjualan = GetDataPenjualanSearch(txtboxnamacustomer.Text, txtboxproduk.Text, txtboxtransno.Text,  txtboxtanggalawal.Text, txtboxtanggalakhir.Text);
            gvpenjualan.DataSource = transpenjualan;
            gvpenjualan.DataBind();
        }
        ...
        public virtual void EditTransRJC(TRANS_PENJUALAN trans)
        {
            using (var context1 = new LAISONEntities())
            {
                ...
                if (penjualan.TANGGAL_BAYAR == null && penjualan.BUKTI_TRANSAKSI == null)
                {
                    penjualan.STATUS = "PD_REQ";
                }

                else if (penjualan.TANGGAL_BAYAR == null && penjualan.BUKTI_TRANSAKSI != null)
                {
                    penjualan.STATUS = "PD_APV_REQ";
                }
        ...
        public virtual DataTable GetDataPenjualanSearch(string custname, string produknama, string transno, string dateawal, string dateakhir)
        {
            LAISONEntities context = new LAISONEntities();
            ...
            var query = (from transpenjualan in context.TRANS_PENJUALAN
                         ...
                         & product.PROD_NAME.Contains(produknama) & transpenjualan.TRANS_NO.Contains(transno)
                         ...
                         select new
                         {
                             ...
                             (
                                ...
                                transpenjualan.STATUS == "CAN_REQ"? "Request Cancel " :
                                "Error"
                             ),
        ...
        public virtual DataTable GetDataPenjualan()
        {
            ...
            var query = (from transpenjualan in context.TRANS_PENJUALAN
                         ...
                         where transpenjualan.STATUS == "CAN_REQ"
                         select new
                         {
                             transpenjualan.TRANS_PENJUALAN_ID,
                             transpenjualan.NAMA_PENERIMA,
